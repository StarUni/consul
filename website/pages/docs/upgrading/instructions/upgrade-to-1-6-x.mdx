...
NOTE: _It's important to upgrade your primary datacenter (the one specified in `acl_datacenter`)
**last**_. If you upgrade the primary datacenter first, it will break replication between your
