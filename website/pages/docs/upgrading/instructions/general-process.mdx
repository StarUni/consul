...
Please note that it's important to run `consul leave` on each server node when shutting
...
- Requesting help in our [Community Forum](https://discuss.hashicorp.com/c/consul/29)
- Contacting [HashiCorp Support](https://support.hashicorp.com/)
